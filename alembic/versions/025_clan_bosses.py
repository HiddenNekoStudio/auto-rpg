"""Add clan_bosses and clan_boss_hits tables

Revision ID: 025_clan_bosses
Revises: 024_player_pets
...
revision: str = '025_clan_bosses'
down_revision: Union[str, None] = '024_player_pets'
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('clan_id', sa.Integer(), nullable=False, index=True),
    ...
    op.create_table(
        'clan_boss_hits',
        sa.Column('id', sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column('clan_boss_id', sa.Integer(), nullable=False, index=True),
...
def downgrade() -> None:
    op.drop_table('clan_boss_hits')
    op.drop_table('clan_bosses')
