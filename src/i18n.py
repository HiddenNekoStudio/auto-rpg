...
STRINGS = {
    "ru": {
        ...
        "stats_weapon_element": "⚔️ Элемент оружия: <b>{element}</b>",
        "stats_pets_total": "🐾 Питомцев куплено: <b>{count}</b>",
        "stats_pets_equipped": "🐾 Экипирован: <b>{name}</b> (ур. {level})",
        "stats_pets_combat": " ⚔️боевой",
        "stats_pets_bonuses": "   Бонусы: <b>{bonuses}</b>",
        "stats_dungeon_done": "🏰 Данжей пройдено: <b>{count}</b>",
        "stats_dungeon_best": "🏰 Рекорд: <b>{floor}</b> комната",
        "stats_dungeon_active": "🚪 Идёт забег: <b>{floor}/{rooms}</b>",
        "stats_arena_best": "⚔️ Рекорд арены: <b>{wave}</b> волн",
        "stats_arena_active": "🌊 Идёт забег: волна <b>{wave}</b>",
        "stats_clan_boss_dmg": "🛡️ Урон клан-боссам: <b>{dmg}</b>",
        "stats_clan_boss_hits": "🛡️ Вкладов: <b>{count}</b>",
        ...
        "btn_hunt":         "🗡️ Охота",
        "hunt_idle":        "🗡️ <b>Охота</b>\n\nТвой герой будет тихо сражаться с монстрами, пока ты онлайн. Волны монстров, MP на активные скиллы, награды в конце.\n\nВыбери режим:",
        "hunt_active":      "🗡️ <b>Охота: {mode}</b>\n⏱️ Осталось: <b>{time}</b>\n⚔️ Убито монстров: <b>{kills}</b>\n💨 Отступлений: <b>{escapes}</b>",
        "hunt_cancel_btn":  "🛑 Прервать",
        "dungeon_idle":     "🏰 <b>Подземелья</b>\n\nТвой герой идёт сквозь комнаты подземелья в автоматическом бою, пока ты онлайн. Каждая комната — бой, последняя — босс.\n\nВыбери подземелье:",
        "dungeon_active":   "🏰 <b>Подземелье: {name}</b>\n🚪 Комната: <b>{floor}/{rooms}</b>\n\nБой идёт автоматически каждые несколько минут. Открой меню позже и нажми «Обновить».",
        "dungeon_started":  "⚔️ Вход в подземелье <b>{name}</b>!",
        "dungeon_cancel_btn": "🛑 Выйти",
        "dungeon_cancelled": "🚪 Ты покинул подземелье.",
        "dungeon_earned":   "Заработано за забег: +{xp} XP, +{gold}💰",
        "arena_idle":       "⚔️ <b>Арена</b>\n\nБесконечные волны монстров в авто-бою, пока ты онлайн. Каждая волна сильнее, каждая 5-я — мини-босс. Награды за каждую волну.\n\nУровень входа: {level}+",
        "arena_active":     "⚔️ <b>Арена</b>\n🌊 Волна: <b>{wave}</b> (рекорд: {best})\n\nБой идёт автоматически каждые несколько минут. Открой меню позже и нажми «Обновить».",
        "arena_started":    "⚔️ Вход на арену! Удачи, герой.",
        "arena_locked":     "🔒 Нужен уровень {level}+ для арены.",
        "arena_already":    "⚔️ У тебя уже есть активный забег на арене!",
        "arena_start_btn":  "⚔️ На арену",
        "arena_cancel_btn": "🛑 Выйти",
        "arena_cancelled":  "🛡️ Ты покинул арену.",
        "arena_earned":     "Заработано за забег: +{xp} XP, +{gold}💰",
        "hunt_started":     "✅ Охота начата! Режим: <b>{mode}</b>, длительность: <b>{hours}ч</b>.\n\nНаграды будут выданы в конце. Прогресс идёт только пока ты онлайн.",
        "hunt_cancelled":   "🛑 <b>Охота прервана.</b>\n",
        "hunt_mode_desc":   "{icon} <b>{mode}</b>\n\n👹 Монстры: {level} ур.\n💰 Награды: <b>×{xp} XP / ×{gold} gold</b>\n🎒 Шанс лута: <b>{loot}%</b>\n🏆 Бонус за выживание: <b>×{survive}</b>\n{death}\n\nВыбери длительность:",
        "hunt_dur_btn":     "🕐 {hours}ч · ×{bonus} · ~{xp} XP / {gold}💰",
        "hunt_death_retreat":"🛡️ Смерть невозможна: отступление при HP &lt; {pct}%",
        "hunt_death_gold":   "💀 Смерть: −{pct}% золота",
        "hunt_death_gold_item": "💀 Смерть: −{pct}% золота, {item}% шанс потерять предмет",
        "hunt_done":        "🏁 <b>Охота завершена!</b>",
        "hunt_dead":        "💀 <b>Охота прервана смертью!</b>",
        "hunt_report_mode": "🗡️ Режим: <b>{mode}</b>",
        "hunt_report_kills": "⚔️ Убито монстров: <b>{kills}</b>",
        "hunt_report_escapes": "💨 Отступлений: <b>{n}</b>",
        "hunt_report_xp":   "✨ XP: <b>+{xp}</b>",
        "hunt_report_gold": "💰 Золото: <b>+{gold}</b>",
        "hunt_report_loot": "🎒 Предметов получено: <b>{n}</b>",
        "hunt_report_gold_lost": "💀 Потеряно золота: <b>−{gold}</b>",
        "hunt_report_item_lost": "💀 Потерян предмет: <b>{slot}</b>",
        ...
        # Ежедневные награды
        "daily_menu_btn":   "📅 Ежедневно",
        "daily_title":      "📅 <b>Ежедневные награды</b>",
        "daily_streak":     "🔥 Стрик: <b>{streak} дн.</b>",
        "daily_cycle":      "🎯 День цикла: <b>{day}/{total}</b>",
        "daily_today":      "📦 Награда сегодня: <b>+{reward} токен(а)</b>",
        "daily_already":    "✅ <b>Сегодня уже получено!</b>",
        "daily_offline_bonus": "💤 Оффлайн: <b>{hours} ч</b> — бонус <b>+{bonus} токен</b>",
        "daily_hint":       "Заходи каждый день, чтобы сохранить стрик!\nПропустишь день — стрик сбросится.",
        "daily_claimed":    "🎁 Награда за вход: <b>+{reward} токен(а)</b>\n🔥 Стрик: {streak} дн.",
        "daily_bonus_line": "💤 Оффлайн-бонус: <b>+{bonus} токен</b>",
        "daily_already_msg": "📅 Сегодня ты уже получил награду.\nЗаходи завтра — стрик продолжится!",
        "daily_claim_btn":  "🎁 Забрать награду",
        "daily_quest_offered": "🎯 <b>Бонусный квест предложен!</b> Выполни его — получишь токены!",
        "clan_btn": "🏰 Клан",
        "clan_no_clan": "У тебя пока нет клана.\nСоздай свой или найди готовый!",
        "clan_create": "🏗️ Создать клан",
        "clan_search": "🔍 Поиск кланов",
        "clan_view": "👁️ Просмотр клана",
        "clan_manage": "⚙️ Управление",
        "clan_donate": "💰 Пожертвовать",
        "clan_leave": "🚪 Покинуть клан",
        "clan_boss": "👹 Клановый босс",
        "clan_boss_wait": "👹 <b>Клановый босс ещё не появился.</b>\nОн появится автоматически. Следи за обновлением!",
        "clan_boss_no": "👹 Клановый босс доступен с уровня клана {level}.",
        "clan_my_invites": "📩 Приглашения: {n}",
        "clan_min_level": "Создать клан можно с уровня {level}.",
        "clan_no_gold": "Недостаточно золота! Нужно: {cost} 💰.",
        "clan_ask_name": "Пришли название клана (2-{max} символа) текстом в чат.",
        "clan_bad_name": "Название должно быть от 2 до {max} символов.",
        "clan_name_taken": "Клан с таким названием уже существует.",
        "clan_already_in": "Ты уже состоишь в клане.",
        "clan_created": "🏰 <b>Клан «{name}» создан!</b>\nПотрачено: {cost} 💰.",
        "clan_none": "Кланов пока нет. Создай первый!",
        "clan_search_title": "🏰 <b>Топ кланов</b>",
        "clan_gone": "Клан больше не существует.",
        "clan_apply": "📝 Подать заявку",
        "clan_full": "Клан полон.",
        "clan_app_exists": "Заявка уже подана, жди ответа.",
        "clan_app_sent": "📨 Заявка отправлена лидеру клана!",
        "clan_no_rights": "Недостаточно прав.",
        "clan_manage_title": "⚙️ <b>Управление кланом</b>\nЗаявок: {pending}",
        "clan_manage_apps": "📩 Заявки",
        "clan_manage_members": "👥 Участники",
        "clan_disband": "💥 Распустить клан",
        "clan_no_apps": "Нет новых заявок.",
        "clan_apps_title": "📩 <b>Заявки на вступление</b>",
        "clan_app_stale": "Заявка устарела или уже обработана.",
        "clan_app_accepted": "✅ Заявка принята!",
        "clan_app_rejected": "❌ Заявка отклонена.",
        "clan_members_title": "👥 <b>Участники</b>",
        "clan_not_member": "Игрок не в клане.",
        "clan_kicked": "🚫 Игрок исключён из клана.",
        "clan_role_changed": "Роль изменена: {role}.",
        "clan_transferred": "👑 Лидерство передано!",
        "clan_disbanded": "💥 Клан распущен.",
        "clan_leader_leave": "Лидер не может покинуть клан. Передай лидерство или распусти клан.",
        "clan_left": "Ты покинул клан.",
        "clan_donate_title": "💰 <b>Пожертвование</b>\nУ тебя: {gold} 💰 | Банк клана: {bank} 💰",
        "clan_donate_all": "Всё",
        "clan_donate_none": "Некуда жертвовать.",
        "clan_donated": "💰 Пожертвовано: {amount}.\nОпыт клана: +{xp} ⚡.",
        "clan_levelup": "🎉 <b>Клан достиг уровня {level}!</b>\nВместимость: {cap} | Бонус ежедневки: +{daily} 🎫",
        "clan_ask_uid": "Пришли UID игрока (только цифры) текстом.",
        "clan_bad_uid": "Некорректный UID. Пришли только цифры.",
        "clan_uid_unknown": "Игрок с таким UID не найден.",
        "clan_invite_exists": "Приглашение этому игроку уже отправлено.",
        "clan_invite_sent": "📨 Приглашение отправлено!",
        "clan_no_invites": "Нет активных приглашений.",
        "clan_invites_title": "📩 <b>Твои приглашения</b>",
        "clan_invite_stale": "Приглашение устарело или уже использовано.",
        "clan_joined": "🎉 Ты вступил в клан!",
        "clan_invite_declined": "Приглашение отклонено.",
    },
    ...
    "en": {
        ...
        "stats_weapon_element": "⚔️ Weapon element: <b>{element}</b>",
        "stats_pets_total": "🐾 Pets owned: <b>{count}</b>",
        "stats_pets_equipped": "🐾 Equipped: <b>{name}</b> (Lv. {level})",
        "stats_pets_combat": " ⚔️combat",
        "stats_pets_bonuses": "   Bonuses: <b>{bonuses}</b>",
        "stats_dungeon_done": "🏰 Dungeons completed: <b>{count}</b>",
        "stats_dungeon_best": "🏰 Record: <b>{floor}</b> room",
        "stats_dungeon_active": "🚪 Run in progress: <b>{floor}/{rooms}</b>",
        "stats_arena_best": "⚔️ Arena record: <b>{wave}</b> waves",
        "stats_arena_active": "🌊 Run in progress: wave <b>{wave}</b>",
        "stats_clan_boss_dmg": "🛡️ Clan boss damage: <b>{dmg}</b>",
        "stats_clan_boss_hits": "🛡️ Contributions: <b>{count}</b>",
        ...
        "btn_hunt":         "🗡️ Hunt",
        "hunt_idle":        "🗡️ <b>Hunt</b>\n\nYour hero will silently fight monsters while you're online. Monster waves, MP for active skills, rewards at the end.\n\nChoose a mode:",
        "hunt_active":      "🗡️ <b>Hunt: {mode}</b>\n⏱️ Time left: <b>{time}</b>\n⚔️ Monsters killed: <b>{kills}</b>\n💨 Escapes: <b>{escapes}</b>",
        "hunt_cancel_btn":  "🛑 Cancel",
        "dungeon_idle":     "🏰 <b>Dungeons</b>\n\nYour hero auto-battles through dungeon rooms while you're online. Each room is a fight, the last one is a boss.\n\nChoose a dungeon:",
        "dungeon_active":   "🏰 <b>Dungeon: {name}</b>\n🚪 Room: <b>{floor}/{rooms}</b>\n\nThe fight runs automatically every few minutes. Open this menu later and hit Refresh.",
        "dungeon_started":  "⚔️ Entering dungeon <b>{name}</b>!",
        "dungeon_cancel_btn": "🛑 Leave",
        "dungeon_cancelled": "🚪 You left the dungeon.",
        "dungeon_earned":   "Earned this run: +{xp} XP, +{gold}💰",
        "arena_idle":       "⚔️ <b>Arena</b>\n\nEndless waves of monsters in auto-battle while you're online. Each wave is stronger, every 5th is a mini-boss. Rewards for each wave.\n\nEntry level: {level}+",
        "arena_active":     "⚔️ <b>Arena</b>\n🌊 Wave: <b>{wave}</b> (best: {best})\n\nThe fight runs automatically every few minutes. Open this menu later and hit Refresh.",
        "arena_started":    "⚔️ Entering the arena! Good luck, hero.",
        "arena_locked":     "🔒 Level {level}+ required for the arena.",
        "arena_already":    "⚔️ You already have an active arena run!",
        "arena_start_btn":  "⚔️ Enter arena",
        "arena_cancel_btn": "🛑 Leave",
        "arena_cancelled":  "🛡️ You left the arena.",
        "arena_earned":     "Earned this run: +{xp} XP, +{gold}💰",
        "hunt_started":     "✅ Hunt started! Mode: <b>{mode}</b>, duration: <b>{hours}h</b>.\n\nRewards are granted at the end. Progress only while you're online.",
        "hunt_cancelled":   "🛑 <b>Hunt cancelled.</b>\n",
        "hunt_mode_desc":   "{icon} <b>{mode}</b>\n\n👹 Monsters: Lv. {level}\n💰 Rewards: <b>×{xp} XP / ×{gold} gold</b>\n🎒 Loot chance: <b>{loot}%</b>\n🏆 Survival bonus: <b>×{survive}</b>\n{death}\n\nChoose a duration:",
        "hunt_dur_btn":     "🕐 {hours}h · ×{bonus} · ~{xp} XP / {gold}💰",
        "hunt_death_retreat":"🛡️ No death: retreat below {pct}% HP",
        "hunt_death_gold":   "💀 Death: −{pct}% gold",
        "hunt_death_gold_item": "💀 Death: −{pct}% gold, {item}% chance to lose an item",
        "hunt_done":        "🏁 <b>Hunt finished!</b>",
        "hunt_dead":        "💀 <b>Hunt ended in death!</b>",
        "hunt_report_mode": "🗡️ Mode: <b>{mode}</b>",
        "hunt_report_kills": "⚔️ Monsters killed: <b>{kills}</b>",
        "hunt_report_escapes": "💨 Escapes: <b>{n}</b>",
        "hunt_report_xp":   "✨ XP: <b>+{xp}</b>",
        "hunt_report_gold": "💰 Gold: <b>+{gold}</b>",
        "hunt_report_loot": "🎒 Items: <b>{n}</b>",
        "hunt_report_gold_lost": "💀 Gold lost: <b>−{gold}</b>",
        "hunt_report_item_lost": "💀 Item lost: <b>{slot}</b>",
        ...
        # Daily rewards
        "daily_menu_btn":   "📅 Daily",
        "daily_title":      "📅 <b>Daily Rewards</b>",
        "daily_streak":     "🔥 Streak: <b>{streak} day(s)</b>",
        "daily_cycle":      "🎯 Cycle day: <b>{day}/{total}</b>",
        "daily_today":      "📦 Today's reward: <b>+{reward} token(s)</b>",
        "daily_already":    "✅ <b>Already claimed today!</b>",
        "daily_offline_bonus": "💤 Offline: <b>{hours} h</b> — bonus <b>+{bonus} token</b>",
        "daily_hint":       "Come back every day to keep your streak!\nMiss a day and the streak resets.",
        "daily_claimed":    "🎁 Login reward: <b>+{reward} token(s)</b>\n🔥 Streak: {streak} day(s)",
        "daily_bonus_line": "💤 Offline bonus: <b>+{bonus} token</b>",
        "daily_already_msg": "📅 You already claimed today's reward.\nCome back tomorrow — the streak continues!",
        "daily_claim_btn":  "🎁 Claim reward",
        "daily_quest_offered": "🎯 <b>Bonus quest offered!</b> Complete it for tokens!",
        "clan_btn": "🏰 Clan",
        "clan_no_clan": "You don't have a clan yet.\nCreate your own or find one!",
        "clan_create": "🏗️ Create clan",
        "clan_search": "🔍 Search clans",
        "clan_view": "👁️ View clan",
        "clan_manage": "⚙️ Manage",
        "clan_donate": "💰 Donate",
        "clan_leave": "🚪 Leave clan",
        "clan_boss": "👹 Clan boss",
        "clan_boss_wait": "👹 <b>Clan boss hasn't appeared yet.</b>\nIt will spawn automatically. Keep checking!",
        "clan_boss_no": "👹 Clan boss is available from clan level {level}.",
        "clan_my_invites": "📩 Invites: {n}",
        "clan_min_level": "You need level {level} to create a clan.",
        "clan_no_gold": "Not enough gold! Need: {cost} 💰.",
        "clan_ask_name": "Send the clan name (2-{max} chars) as text.",
        "clan_bad_name": "Name must be 2-{max} characters long.",
        "clan_name_taken": "A clan with this name already exists.",
        "clan_already_in": "You are already in a clan.",
        "clan_created": "🏰 <b>Clan «{name}» created!</b>\nSpent: {cost} 💰.",
        "clan_none": "No clans yet. Create the first one!",
        "clan_search_title": "🏰 <b>Top clans</b>",
        "clan_gone": "This clan no longer exists.",
        "clan_apply": "📝 Apply",
        "clan_full": "The clan is full.",
        "clan_app_exists": "Application already sent, wait for an answer.",
        "clan_app_sent": "📨 Application sent to the clan leader!",
        "clan_no_rights": "Not enough rights.",
        "clan_manage_title": "⚙️ <b>Manage clan</b>\nApplications: {pending}",
        "clan_manage_apps": "📩 Applications",
        "clan_manage_members": "👥 Members",
        "clan_disband": "💥 Disband clan",
        "clan_no_apps": "No new applications.",
        "clan_apps_title": "📩 <b>Membership applications</b>",
        "clan_app_stale": "Application is stale or already processed.",
        "clan_app_accepted": "✅ Application accepted!",
        "clan_app_rejected": "❌ Application rejected.",
        "clan_members_title": "👥 <b>Members</b>",
        "clan_not_member": "Player is not in the clan.",
        "clan_kicked": "🚫 Player kicked from the clan.",
        "clan_role_changed": "Role changed: {role}.",
        "clan_transferred": "👑 Leadership transferred!",
        "clan_disbanded": "💥 The clan was disbanded.",
        "clan_leader_leave": "The leader cannot leave. Transfer leadership or disband the clan.",
        "clan_left": "You left the clan.",
        "clan_donate_title": "💰 <b>Donation</b>\nYou have: {gold} 💰 | Clan bank: {bank} 💰",
        "clan_donate_all": "All",
        "clan_donate_none": "Nothing to donate.",
        "clan_donated": "💰 Donated: {amount}.\nClan XP: +{xp} ⚡.",
        "clan_levelup": "🎉 <b>The clan reached level {level}!</b>\nCapacity: {cap} | Daily bonus: +{daily} 🎫",
        "clan_ask_uid": "Send the player UID (digits only) as text.",
        "clan_bad_uid": "Invalid UID. Send digits only.",
        "clan_uid_unknown": "No player with this UID.",
        "clan_invite_exists": "Invite to this player already sent.",
        "clan_invite_sent": "📨 Invite sent!",
        "clan_no_invites": "No active invites.",
        "clan_invites_title": "📩 <b>Your invites</b>",
        "clan_invite_stale": "Invite is stale or already used.",
        "clan_joined": "🎉 You joined the clan!",
        "clan_invite_declined": "Invite declined.",
    },
}
